...
<div id="cj-wrapper">
	...
	<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option='.S_APP_NAME.'&view=reports&task=location_report&id='.$this->item->id.':'.$this->item->alias.$itemid)?>" method="post">
		...
		<div class="row-fluid">
			...
			echo CJFunctions::get_pagination(
					'index.php?option='.S_APP_NAME.'&view=reports&task=location_report&id='.$this->item->id.':'.$this->item->alias.$itemid, 
